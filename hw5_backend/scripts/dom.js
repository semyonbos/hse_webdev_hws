...
export class DOMBuilder {
    ...
    static createForm(fields, screenId) {
        ...
        fields.forEach(function(field) {
            ...
            switch(field.type) {
                ...
                case 'location':
                    ...
                    input = DOMBuilder.createElement('input', 'form-input');
                        // Use explicit text input for location fields (browser unknown types fallback to text)
                        input.type = 'text';
            ...
            } else if (field.type === 'location' || field.type === 'review') {
                // 'location' and 'review' types append their own structure inside the switch
                // (location already appended label + locationGroup; review is a static div)
            } else {
                input.name = field.name;
